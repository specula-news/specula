# Sources for aggregation site - FIXED (v20.5.29)
...
SOURCES = [
    ...
    # --- MEDIA: USA (FIXED: TYPE IS NOW WEB) ---
    {"url":"http://feeds.bbci.co.uk/news/world/rss.xml","cat":"geopolitics","type":"web","source_name":"BBC World","lang":"en","filter_tag":"usa"},
    {"url":"https://www.bloomberg.com/europe","cat":"geopolitics","type":"web","source_name":"Bloomberg","lang":"en","filter_tag":"usa"},
    {"url":"https://rss.nytimes.com/services/xml/rss/nyt/HomePage.xml","cat":"geopolitics","type":"web","source_name":"The New York Times","lang":"en","filter_tag":"usa"},
