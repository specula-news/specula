...
SOURCES = [
    ...
    # --- GEO: Sweden ---
    # FIXED: Was pointing to HTML page, now points to RSS and correct language
    {"url":"https://www.borskollen.se/rss/nyheter","cat":"geopolitics","type":"web","source_name":"Börskollen","lang":"sv","filter_tag":"sweden"},
